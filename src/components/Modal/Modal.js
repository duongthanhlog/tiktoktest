        ...
        <div className={cx('overlay', {active})}>
           <div className={cx('wrapper')}>
            <div className={cx('close_wrap')}>
                <button onClick={handleCloseModal}>
                    <CloseIconModal width='25px' height='25px' className={cx('icon')}/>
                </button>
            </div>
           <div className={cx('body')}>
                ...
                <ul className={cx('login_list')}>
                    ...
                    <li className={cx('login_item')}>
                        <LineIcon width='2rem' height='2rem'/>
                        Tiếp tục với Line
                    </li>
                    <li className={cx('login_item')}>
                        <KakaotalkIcon width='2rem' height='2rem'/>
                        Tiếp tục với Kakaotalk
                    </li>
                    <li className={cx('login_item')}>
                        <AppleIcon width='2rem' height='2rem'/>
                        Tiếp tục với Apple
                    </li>
                    <li className={cx('login_item')}>
